<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="E_commerceWebsite.User.Invoice" %>
        ...
        <div class="container">
            ...
            <div class="text-center">
                <asp:LinkButton ID="lbDownloadInvoice" runat="server" cssclass="btn btn-info" OnClick="lbDownloadInvoice_Click">
                   <i class="fa fa-file-pdf-0 mr-2"></i> Download Invoice
                </asp:LinkButton>
            </div>
        </div>
    </section>
